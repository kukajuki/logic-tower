...
export const LV1_QUESTIONS: Question[] = [
  {
    ...
    phase1: {
      ...
      cards: [
        ...
        { id: "c3", text: "自社の体制で実現できるか？", type: "argument", tier: 1, phrase: "自社で実現できるか？", reason: "新規参入・拡大型の右：実現性のサブイシュー。このサブイシューに根拠が答えることで、結論「段階的に取り込むべき」を支える。" },
        { id: "c4", text: "競合の星野リゾートは顧客動線の分離設計で両立に成功", type: "evidence", tier: 2, phrase: "星野リゾートが動線分離で成功", reason: "守りの裏付け事例。中央に配置。" },
        { id: "c5", text: "インバウンド市場に十分な需要はあるか？", type: "argument", tier: 1, phrase: "需要は十分か？", reason: "新規参入・拡大型の左：市場・需要のサブイシュー。このサブイシューに根拠が答えることで、結論「段階的に取り込むべき」を支える。" },
  ...
  },
  {
    ...
    phase1: {
      ...
      cards: [
        ...
        { id: "c3", text: "組織は変革を受容する準備があるか？", type: "argument", tier: 1, phrase: "組織は受容できるか？", reason: "優先順位型の右：次に重要な判断軸（実現性）。このサブイシューに根拠が答えることで、結論「生産管理を最優先」を支える。" },
        { id: "c4", text: "現場の受容性：生産管理部門のITリテラシー調査でスコア最高", type: "evidence", tier: 2, phrase: "ITリテラシーが最高", reason: "内部データを右端で補完。" },
        { id: "c5", text: "どの領域のROIが最も高いか？", type: "argument", tier: 1, phrase: "どこのROIが最も高いか？", reason: "優先順位型の左：最も重要な判断軸（ROI）。このサブイシューに根拠が答えることで、結論「生産管理を最優先」を支える。" },
  ...
  },
  {
    ...
    phase1: {
      ...
      cards: [
        ...
        { id: "c3", text: "既存ナビサイト経由を縮小しても許容範囲か？", type: "argument", tier: 1, phrase: "既存縮小は許容範囲か？", reason: "チャネル転換型の右：既存チャネルへの影響。このサブイシューに根拠が答えることで、結論「ダイレクトへ移行」を支える。" },
        { id: "c4", text: "ダイレクト経由の1年後定着率92%、ナビ経由は76%", type: "evidence", tier: 2, phrase: "定着率92%vs76%", reason: "品質差を中央に。" },
        { id: "c5", text: "ダイレクト経由は既存ナビ比で優位性があるか？", type: "argument", tier: 1, phrase: "新チャネルに優位性はあるか？", reason: "チャネル転換型の左：新チャネルの優位性。このサブイシューに根拠が答えることで、結論「ダイレクトへ移行」を支える。" },
  ...
  },
  {
    ...
    phase1: {
      ...
      cards: [
        ...
        { id: "c3", text: "値上げしても顧客は離れないか？", type: "argument", tier: 1, phrase: "顧客は離れないか？", reason: "価格変更型の右：顧客離反のサブイシュー。このサブイシューに根拠が答えることで、結論「8%値上げ＋緩和策」を支える。" },
        { id: "c4", text: "競合の松屋は10%値上げ後もリピート率を維持(品質訴求戦略)", type: "evidence", tier: 2, phrase: "松屋は値上げでもリピート維持", reason: "競合事例を中央に。" },
        { id: "c5", text: "値上げなしで事業は継続できるか？", type: "argument", tier: 1, phrase: "値上げなしで継続できるか？", reason: "価格変更型の左：財務必要性のサブイシュー。このサブイシューに根拠が答えることで、結論「8%値上げ＋緩和策」を支える。" },
  ...
  },
  {
    ...
    phase1: {
      ...
      cards: [
        ...
        { id: "c5", text: "対面にはリモートを上回る組織的価値があるか？", type: "argument", tier: 1, phrase: "対面に変革の必要性はあるか？", reason: "組織変革型の左：変革の必要性のサブイシュー。このサブイシューに根拠が答えることで、結論「職種別に段階移行」を支える。" },
